...
function read_value() {
 ...
 $.getJSON(url, function (json) {
     ...
     imagel = document.createElement("IMG");
     imagel.setAttribute("src", "img/left1.png");
     imagel.setAttribute("width", "50");
     imagel.setAttribute("height", "70");

     imager = document.createElement("IMG");
     imager.setAttribute("src", "img/right1.png");
     imager.setAttribute("width", "50");
     imager.setAttribute("height", "70");

     var alinknxt = document.createElement("A");
     alinknxt.className = "control_next";
     //alinknxt.innerHTML = ">";
     alinknxt.appendChild(imager);

     var alinkprev = document.createElement("A");
     alinkprev.className = "control_prev";
     //alinkprev.innerHTML = "<";
     alinkprev.appendChild(imagel);
